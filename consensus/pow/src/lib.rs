...
use sp_consensus::import_queue::{ BoxBlockImport, BasicQueue, Verifier, BoxJustificationImport };
...
impl<B, I, C, S, Algorithm, CAW> PowBlockImport<B, I, C, S, Algorithm, CAW>
	where
		B: BlockT,
...
impl<B, I, C, S, Algorithm, CAW> BlockImport<B>
	for PowBlockImport<B, I, C, S, Algorithm, CAW>
	where
		B: BlockT,
		I: BlockImport<B, Transaction = sp_api::TransactionFor<C, B>> + Send + Sync,
...
pub fn start_mining_worker<Block, C, S, Algorithm, E, SO, CAW>(
	...
	-> (Arc<Mutex<MiningWorker<Block, Algorithm, C>>>, impl Future<Output = ()>)
	where
		Block: BlockT,
